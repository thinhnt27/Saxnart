...
//        String remoteAddr = request.getRemoteAddr();
        ...
        ipAddresses.add("113.52.45.78");
        ipAddresses.add("116.97.245.130");
        ipAddresses.add("42.118.107.252");
        ipAddresses.add("113.20.97.250");
        ipAddresses.add("203.171.19.146");
        ipAddresses.add("103.220.87.4");
        ipAddresses.add("103.220.86.4");

        // Địa chỉ 113.160.92.202
        ipAddresses.add("113.160.92.202");
        if (ipAddresses.contains(headerAddr)) {
...
//                                    return ResponseEntity.status(HttpStatus.OK).body(new ResponeCustom("02", "Order already confirmed"));
                ...
                .body(new ResponeCustom("failed", "ip not whitelist"));

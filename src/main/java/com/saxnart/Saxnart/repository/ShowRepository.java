...
public interface ShowRepository extends JpaRepository<ShowEntity, Long> {
    ...
    ShowEntity findFirstByShowDateAfterOrderByShowDateAsc(Date currentDate);

//    ShowEntity findByShowDate(Date showDate);

    @Query("SELECT s FROM ShowEntity s WHERE DATE(s.showDate) = :showDate")
    ShowEntity findByShowDate(@Param("showDate") Date showDate);
